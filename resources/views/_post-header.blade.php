        ...
        <div class="relative lg:inline-flex bg-gray-100 rounded-xl">
            ...
            <div x-data="{ show: false }" @click.away="show = false">
                <button @click="show =! show"
                    class="py-2 pl-3 pr-9 font-semibold text-sm w-full lg:w-32 text-left flex lg:inline-flex">
                ...
                <div x-show="show" class="py-2 absolute bg-gray-100 w-full rounded-xl mt-2 z-50" style="display: none">
                    <a href="/"
