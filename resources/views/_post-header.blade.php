<header class="max-w-xl mx-auto mt-20 text-center">
    ...
    <div class="space-y-2 lg:space-y-0 lg:space-x-4 mt-4">
        ...
        <div class="relative lg:inline-flex bg-gray-100 rounded-xl">
            ...
            <x-dropdown>
                <x-slot name="trigger">
                    <button class="py-2 pl-3 pr-9 font-semibold text-sm w-full lg:w-32 text-left flex lg:inline-flex">
                ...
                @foreach ($categories as $category)
                    <x-dropdown-item href="/?category={{ $category->slug }}" 
                        ...
                        {{-- we can do it another way like->isset($CurrentCategory) && $CurrentCategory->is($category) /
        ...
        <!-- if find Other Filters using like this -->
